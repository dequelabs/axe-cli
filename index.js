...
.option('--load-delay <n>', 'Set how much time (milliseconds) axe will wait after page load before running the audit (default: 0)', 0)
.option('--timeout <n>', 'Set how much time (seconds) axe has to run (default: 90)', 90)
